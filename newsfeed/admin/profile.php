        ...
        <div class="col-12 col-lg-6 col-md-6">
            ...
            <img src="upload/dp/<?php if(!empty($dp)){ echo $dp; }else{ echo "1.jpg"; } ?>" class="rounded img-fluid  card-img-top"  style="height: 300px "  alt="...">
                ...
                <h2 class="text-center mb-4"><?php echo $name; ?> </h2>
                    ...
                    <p class="text-center">
                    <a href="edit-profile.php" class="btn btn-outline-primary">Thay đổi thông tin</a>
                    <a href="change-pass.php" class="btn btn-outline-primary">Thay đổi mật khẩu</a>
                    <a href="change-dp.php" class="mt-2 btn btn-outline-primary">Thay đổi avata</a>
                    </p>
                </div>
            </div>
        </div>
