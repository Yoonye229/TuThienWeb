...
<div class="container mb-5">
    <div class="row mt-5">
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card shadow " >
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Các chương trình</li>
                    <li class="list-group-item">Tổng chương trình: <span class="text-center"> <?php echo mysqli_num_rows($result); ?> </span> </li>
                    <li class="list-group-item text-center"><a href="manage-category.php"><b>Thông tin chương trình</b></a></li>
                </ul>
            </div>
        </div>
        <!-- <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card shadow " >
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Chi tiết các mục chương trình</li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card shadow " >
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Các bài báo</li>
                    <li class="list-group-item text-left">Tổng bài báo : <?php 
                        if($total_post_result){
                            echo mysqli_num_rows($total_post_result);
                        }
                    ?></li>
                    <li class="list-group-item text-center"><a href="manage-post-desc.php"><b>Thông tin bài báo</b></a>   </li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="card shadow " >
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>Thông tin liên lạc </b> </li>
                    <li class="list-group-item"><b>  Địa chỉ : </b>  <?php echo $address; ?> </li>
                    <li class="list-group-item"><b> STĐ :  </b>   <?php echo $phn_no; ?> </li>
                    <li class="list-group-item"><b>  Email : </b>   <?php echo $email; ?></li>
                    <li class="list-group-item"><b> Fax  :   </b> <?php echo $fax_no; ?></li>
                    <li class="list-group-item text-center"> <a href="contact-us.php"><b>Thay đổi</b> </a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row mt-5 bg-white shadow">
        ...
        <div class="" >
                ...
                <li class="list-group-item text-center" style="font-size:29px;"> <b>Thông tin: </b> </li>
                <li class="list-group-item text-center"> <a class="btn btn-outline-primary" href="about-us.php"><b>Chỉnh sửa</b> </a> </li>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 "> 
           <div class=" pt-5">
                <ul>
                   <li style='color:blue'></li> <?php echo $about_us;?> </li>
                </ul>
           </div>
        </div>
    </div>
