        ...
        if( !empty($category) && !empty($editor) && !empty($p_heading) && !empty( $thumbnail_name) ){
            ...
            if($result_update_desc){
                ...
                $(document).ready( function(){
                    ...
                    $('#linkBtn').text('Toàn bộ bài mô tả');
                    $('#addMsg').text('Bạn đã thêm mô tả!');
    ...
    <div id="form" class="pt-5 form-input-content">
        <div class="card login-form mb-0">
            <div class="card-body pt-3 shadow">
                <h4 class="text-center">Chỉnh sửa mô tả bài báo </h4>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="submit" value="Sửa" class="btn login-form__btn submit w-10 " name="submit_expense" >
                    </div>
