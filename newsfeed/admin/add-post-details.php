...
<?php
    ...
    if( $_SERVER["REQUEST_METHOD"] == "POST" ){
        ...
        if( empty($_REQUEST["heading"])){
            $heading_err =  "<p style='color:red'> * Vui lòng chọn tiêu đề </p>";
        }else {
          $heading = $_REQUEST["heading"];
        }

        if( empty( $_REQUEST["detail"] ) ){
            $detail_err = "<p style='color:red'> * Vui lòng viết chi tiết bài báo </p>";
        }else{
                        ...
                        if($add_post_by_1){
                            $heading = $detail = "";
                                    ...
                                    $(document).ready( function(){
                                        ...
                                        $('#linkBtn').text('Xem chi tiết bài báo');
                                        $('#addMsg').text('Chuyển trang thêm bài báo !');
    ...
    <div id="form" class="pt-5 form-input-content">
        <div class="card login-form mb-0">
            <div class="card-body pt-3 shadow">
                <h4 class="text-center">Chi tiết bài báo</h4>
                <form method="POST" enctype="multipart/form-data" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>"> 
                <div class="form-group">
                        <label >Vui lòng chọn tiêu đề: </label>
